...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Book b1 = new Book(1, "The Great Gatsby", "F. Scott Fitzgerald", "Classic", 4.5,
                "Roaring Twenties, American Novel", "A story of Jay Gatsby...", "2023-10-01");
        Book b2 = new Book(2, "To Kill a Mockingbird", "Harper Lee", "Fiction", 4.7,
                "Southern Gothic, Bildungsroman", "A novel about social issues...", "2023-11-15");
        ...
        Book b10 = new Book(10, "The Hobbit", "J.R.R. Tolkien", "Fantasy", 4.8,
                "Adventure, Epic Fantasy", "An unexpected journey...", "2023-10-12");
        Book b11 = new Book(11, "The Notebook", "Nicholas Sparks", "Romance", 4.4,
                "Love, Drama", "A touching love story...", "2023-11-03");
        Book b12 = new Book(12, "Dune", "Frank Herbert", "Sci-Fi", 4.7,
                "Space, Politics", "A struggle on planet Arrakis...", "2023-12-21");
        Book b13 = new Book(13, "The Shining", "Stephen King", "Horror", 4.5,
                "Haunted Hotel, Horror", "Terror in a remote hotel...", "2023-09-29");
        Book b14 = new Book(14, "Norwegian Wood", "Haruki Murakami", "Slice of Life", 4.3,
                "Youth, Melancholy", "A nostalgic story...", "2023-10-18");
        Book b15 = new Book(15, "The Kite Runner", "Khaled Hosseini", "Drama", 4.6,
                "Friendship, Conflict", "A tale of guilt and redemption...", "2023-12-08");
        Book b16 = new Book(16, "Moby Dick", "Herman Melville", "Classic", 4.2,
                "Adventure, Sea", "Hunting the white whale...", "2023-11-11");
        ...
        bookDB.addBookToDatabase(b3); bookDB.addBookToDatabase(b4);
        bookDB.addBookToDatabase(b5); bookDB.addBookToDatabase(b6);
        bookDB.addBookToDatabase(b7); bookDB.addBookToDatabase(b8);
        bookDB.addBookToDatabase(b9); bookDB.addBookToDatabase(b10);
        bookDB.addBookToDatabase(b11); bookDB.addBookToDatabase(b12);
        bookDB.addBookToDatabase(b13); bookDB.addBookToDatabase(b14);
        bookDB.addBookToDatabase(b15); bookDB.addBookToDatabase(b16);
        bookDB.addBookToDatabase(b17); bookDB.addBookToDatabase(b18);

        // Masukkan buku ke TREE (genre)
